...
import 'package:studyplanner/models/plan_task.dart';
import 'package:studyplanner/services/notification_services.dart';
...
import 'package:studyplanner/widgets/plan_task_bar.dart';
import 'package:studyplanner/widgets/task_tile.dart';

class PlansHomePage extends StatefulWidget {
  const PlansHomePage({Key? key}) : super(key: key);
  ...
  return Container(
    ...
    child: Row(
      ...
      children: [
        ...
        Mybutton(Label:"+ Plans", onTap: ()async{
      ...
      leading: GestureDetector(
        onTap: (){
          ...
          notifyHelper.displayNotification(
            title:"Tema Berubah",
            body:Get.isDarkMode?"Light Mode Aktif ":"Dark Mode Aktif"
          );
        },
